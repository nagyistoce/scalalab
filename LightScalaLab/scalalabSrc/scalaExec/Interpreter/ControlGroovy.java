...
return "int["+((int [][])grResult).length+"] ["+((int [][])grResult)[0].length+ "] = \n"+
 ...
 public  static void  warmUpGroovy() {
            ...
            GroovyShellPathsList.add(JavaGlobals.javacppFile);
            GroovyShellPathsList.add(JavaGlobals.gslFile);
            ...
            System.out.println("appending to GroovyShell path: "+JavaGlobals.javacppFile);
            System.out.println("appending to GroovyShell path: "+JavaGlobals.gslFile);
